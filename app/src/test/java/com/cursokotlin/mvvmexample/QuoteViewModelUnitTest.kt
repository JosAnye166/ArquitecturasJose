package com.joseangel.arquitectura

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import com.joseangel.arquitectura.domain.GetQuotesUseCase
import com.joseangel.arquitectura.domain.GetRandomQuoteUseCase
import com.joseangel.arquitectura.domain.model.Quote
import com.joseangel.arquitectura.ui.viewmodel.QuoteViewModel
...
class QuoteViewModelUnitTest {
    ...
    fun `when viewmodel is created at the first time, get all quotes and set the first value`() = runTest{
        //Given
        val quote = listOf(Quote("Jola", "Jose"), Quote("Holla mundo", " Angel "))
